...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\rasal\Downloads\FER\train')
    ii=0
    for pa in my_list:

        print(pa,"==================",ii)
        for root, dirs, files in os.walk(r'C:\Users\rasal\Downloads\FER\train\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\rasal\Downloads\FER\train\\'+pa, f)
...
# load dataset
x_dataset, y_dataset = read_dataset(r"C:\Users\rasal\Downloads\FER\train")
