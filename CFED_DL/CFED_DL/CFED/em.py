...
def camclick():
    ...
    while(True):
        ...
        for (x, y, w, h) in faces:
            ...
            print(emotion,"jjjjjjjjjjjjjjjjjjjjj")
            # qrr2 = requests.get("http://" + ip_address + ":5000/insertEmotions?emo=" + emotion)

        # return detected_name

        # qrr = requests.get("http://" + ip_address + ":5000/insertAttendance?staffid=" + str(npy runserver 198.16ame) + "&type=" + type)
