...
public class  custom_avgemotion extends BaseAdapter{
    ...
    public custom_avgemotion(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_avgemotion, null);
...
//                Intent i=new Intent(context,viewemotions.class);
//                i.putExtra("eid",c.get(position));
...
//                String url = "http://" + sh.getString("ip", "") + ":5000/avgemotion";
//
