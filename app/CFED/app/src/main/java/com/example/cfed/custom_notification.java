...
public class custom_notification extends BaseAdapter{
    ...
    public custom_notification(Context applicationContext, ArrayList<String> a, ArrayList<String> b,ArrayList<String> c,ArrayList<String> d,ArrayList<String> e) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_notification, null);
        ...
        TextView tv5=(TextView)gridView.findViewById(R.id.ij);
